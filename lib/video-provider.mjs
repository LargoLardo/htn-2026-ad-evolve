...
export async function renderVideo(prompt, brief, { signal } = {}) {
  ...
  // Official Pika model-specific machine-readable specification uses these
  // fields. Keep the exact generation profile in the cache/idempotency key.
  const body = { prompt, resolution: '720p', aspect_ratio: brief.aspectRatio, duration: brief.videoDuration };
