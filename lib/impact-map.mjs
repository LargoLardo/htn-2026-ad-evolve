 ...
 */
export async function buildImpactMap(original, brief, { signal, baseline, contractHash, elements = [], onProgress, concurrency = Number(process.env.TRIBE_CONCURRENCY) || 1 } = {}) {
