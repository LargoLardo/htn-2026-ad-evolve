 ...
 */
export async function buildImpactMap(original, brief, { signal, baseline, contractHash, grid = DEFAULT_GRID, onProgress, concurrency = Number(process.env.PERCEPT_CONCURRENCY) || 1 } = {}) {
