...
/** The meaningful family for a silent still image.
 *
...
export async function buildMaps(asset, brief, {
  ...
  // Attention needs no GPU, so when TRIBE is down there is still half a map
  ...
  // Both normalised first: gaze density and a neural delta are not the same
