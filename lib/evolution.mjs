...
export const selectionScore = candidate => candidate.scores.neural?.source === 'tribe-percept' ? candidate.scores.neural.engagementScore : candidate.scores.fitness;
...
export function compareCandidates(a, b) {
  return selectionScore(b) - selectionScore(a) || b.scores.fitness - a.scores.fitness;
}
