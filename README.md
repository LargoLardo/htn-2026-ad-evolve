...
- **Neural Scoring**: Shortlisted takes are scored by TRIBE, a neuroscience model that predicts cortical response across four Glasser parcel families. In the future, more accurate decoding of TRIBE results can be attained using a locally trained model on the online OASIS dataset.
