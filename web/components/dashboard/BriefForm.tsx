  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3 border-t border-border pt-4">
        ...
        <p className="text-xs text-foreground-lighter">Neural overall score: four equally weighted Glasser families, measuring the magnitude of the predicted cortical response against the original. Selection takes the largest among reviewed takes; if all fail, provisional drafts remain visible. A larger predicted response is not by itself evidence of a better ad.</p>
      </div>
