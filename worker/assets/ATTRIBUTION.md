...
Changes: retained fsaverage vertices numbered 0–10,241 in each hemisphere, shifted right-hemisphere indices by 10,242, and combined left/right vertices under each bare parcel name. These are the same annotation files, nesting operation and bilateral grouping used by Percept/TRIBE. Source file checksums are in the JSON. No mesh or model weights are bundled.
