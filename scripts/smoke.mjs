...
assert.match(config.tribeStatus, /Neural|scoring/);
...
console.log(JSON.stringify({ url: base, checks: 'API-only backend, TRIBE/Seedance configuration, saved-run listing, origin protection; no generation or inference' }));
